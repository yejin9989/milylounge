...
<% session.setAttribute("page", "pyung.jsp"); %>
<% //데스크탑 금지
...
session.setAttribute("page", "pyung.jsp"); // 현재 페이지 current page
// 세션 가져오기 get session
...
<span>가로폭을 cm단위로 입력하세요. </span>
<br>
<input style="margin:10px 0; padding:5px;ime-mode:disabled;" id="val2" type="text" onkeydown='return onlyNumber(event)' onkeyup='removeChar(event)'> cm
<br>
...
<input type="button" style="width:180px;height:30px; background-color:#5d5757; border:none; border-radius: 5px; color:white;margin:20px;" value="계산" onclick="checkradio()">
<br><br>
...
<div id="result" style="width:75%; padding:10px; margin-top:40px; text-align:center; display:inline-block;">
	<div id="bordertable" style="width:95%;height:150px; display:inline-block; border:1px solid #b3b2b2;">
		...
		<div style="width:50%; background-color:#d8d7d7; height:25%; line-height:2.5em; float:left; border-bottom:1px solid #b3b2b2;">
			<span style="color:red;">※MD추천※</span>2배주름<br>
			(풍성한 주름)
		</div>
		<div style="width:49.45%; background-color:white; height:50%; line-height:5em; float:left; border-bottom:1px solid #b3b2b2; border-right:1px solid #b3b2b2;">
		<span id="1">-</span>
		</div>
...
<div id="result2" style="width:75%; padding:10px; padding-bottom:50px; margin:5px;text-align:center; display:inline-block;">
	<div id="bordertable" style="width:95%;height:150px; display:inline-block; border:1px solid #b3b2b2;">
		<div style="width:100%; background-color:#5d5757; height:25%; line-height:2.5em; border-bottom:1px solid #b3b2b2;">
...
<!-- 
<div style="text-align:center; width:75%;display:inline-block;border:1px solid #c8c8c8;border-radius:5px;overflow:hidden;margin:20px;">
	<div style="background-color:#5d5757; width:100%;height:40px;line-height:30px;display:table;">
	...
	<div style="border-bottom:1px solid #c8c8c8;width:100%;height:50px;overflow:hidden;display:table;">
		<div style="background-color:#d8d7d7;width:50%;height:100%;display:table-cell;vertical-align:middle;">
		<div>
			1.5배주름<br>
			(보통 주름)
		</div>
	...
	<div style="width:100%;height:50px;overflow:hidden;display:table;">
		<div style="background-color:#d8d7d7;width:50%;height:100%;display:table-cell;vertical-align:middle;">
		<div>
			<span style="color:red;">※MD추천※</span>2배주름<br>
			(풍성한 주름)
...
<div style="text-align:center; width:75%;display:inline-block;border:1px solid #c8c8c8;border-radius:5px;overflow:hidden;margin:20px;">
	...
	<div style="width:100%;height:100px;overflow:hidden;display:table;">
		<div style="background-color:#d8d7d7;width:50%;height:100%;display:table-cell;vertical-align:middle;">
		<div>
			커튼봉에 설치할 경우
		</div>
		</div>
		<div style="width:100%;height:50%;line-height:49px;border-bottom:1px solid #c8c8c8;">
			<div id=4>
			 - 
			</div>
		</div>
