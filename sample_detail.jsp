...
<% session.setAttribute("page", "sample_detail.jsp"); %>
<!DOCTYPE html>
<html>
<head>
...
session.setAttribute("page", "sample_detail.jsp"); // 현재 페이지 current page
// 세션 가져오기 get session
...
String m_img="";//main image
String d_img="";//detail image
String url="";
String i_name = "";
String price = "";
String img = "";
while(rs.next()){
	...
	/*m_img = rs.getString("Image2");
	d_img = rs.getString("Image3");*/
...
<div style="margin:40px 0 0 0;">
    ...
    <h2 style="text-align:center;padding:20px 0"><%=i_name%><br></h2>
    <p style="text-align:center; padding:0 0 20px 0; font-size:17px;">가격:<%=price%>원<br></p>
    </a>
    </div>
