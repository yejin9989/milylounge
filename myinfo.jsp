...
while(rs.next()){
	...
	profile = rs.getString("PROFILE");if(profile==null) profile="img/unnamed.png";
	nickname = rs.getString("NICKNAME");if(nickname==null) nickname="";
}
pstmt.close();
rs.close();
query="";
...
<h2>나의 정보</h2>
<div style="padding:20px 0 10px 0"><img src=<%=profile%> style="width:90px;height:90px;border-radius:50px;border:1px solid #dedede;"></div>
<div><a href="changeprofile.jsp" onClick="window.open('changeprofile.jsp?id=<%=s_id%>', 'pagename','resizable,height=260,width=500');return false;">프로필 사진 수정</a></div>
<table class="mydata" style="padding:10px;">
