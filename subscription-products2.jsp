...
label input[type="checkbox"] + span::before, .demo1 label input[type="checkbox"] + span::after {
  position: absolute;
  top: 0;
  left: 0;
  display: inline-block;
...
session.setAttribute("page", "index1.jsp"); // 현재 페이지 current page
// 세션 가져오기 get session
...
<div style="margin:40px 0 0 0;">
  <div style="padding:60px;padding-top:100px;display:block;height:50px;">
    <p style="text-align:center;font-size:20px;">구매할 상품을 선택하세요</p>
  </div>
  <div style="margin:15px;">
    <p style="font-size:15px;">정기구독 상품</p>
  </div>
  <label>
